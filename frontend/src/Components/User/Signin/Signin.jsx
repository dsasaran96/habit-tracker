...
import { resetSigninState, signinUser } from 'Components/User/UserSlice'
    ...
    return (
        <PageContainer>
            ...
            <SigninContainer>
                ...
                <div>Don't have an account? <StyledLink to="/register" onClick={handleResetState}>Register here</StyledLink></div>
            </SigninContainer>
        </PageContainer>
    )
}
